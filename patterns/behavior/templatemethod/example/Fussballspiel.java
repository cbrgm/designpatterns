 ...
 *
 */
public class Fussballspiel extends Spiel {
	...
	@Override
	void initiiere() {
		System.out.println("Fussballspiel wird vorbereitet.");
	...
	@Override
	void starteSpiel() {
		System.out.println("Fussballspiel wird gestartet.");
	...
	@Override
	void beendeSpiel() {
		System.out.println("Fussballspiel wird beendet.");
